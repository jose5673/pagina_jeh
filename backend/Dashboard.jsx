...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    const getRetryDelay = () => {
      // Si estamos conectados, actualizar cada 100ms para reflejar cambios en tiempo real
